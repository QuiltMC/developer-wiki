...
public class AttributesExample implements ModInitializer {
	...
	public void onInitialize(ModContainer mod) {
		...
		Registry.register(Registry.ATTRIBUTE, new Identifier(modId, "generic.jump_boost"), GENERIC_JUMP_BOOST);
		// @end Register-Attribute
		Registry.register(Registry.ITEM, new Identifier(modId, "jump_stick"), JUMP_STICK);
