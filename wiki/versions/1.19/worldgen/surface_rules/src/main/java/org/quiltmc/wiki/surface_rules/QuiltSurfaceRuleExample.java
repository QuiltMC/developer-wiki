...
package org.quiltmc.wiki.surface_rules;
...
public class QuiltSurfaceRuleExample implements SurfaceRuleEvents.OverworldModifierCallback,
	...
	public void modifyTheEndRules(SurfaceRuleContext.TheEnd context) {
		...
		SurfaceRules.MaterialCondition whiteBiome = SurfaceRules.biome(BiomeKeys.THE_END);
